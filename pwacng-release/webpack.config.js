...
module.exports = async env => {
    ...
    if (process.env.MAGENTO_CDN_URL) {
        config.output.publicPath = process.env.MAGENTO_CDN_URL;
    }
    ...
    config.plugins = [
        ...
        new DefinePlugin({
            ...
            STORE_VIEW_CODE: process.env.STORE_VIEW_CODE
                ...
                : JSON.stringify(storeConfigData.store_code),
            ...
            GOONG_KEY: JSON.stringify(
                process.env.GOONG_KEY || ''
            ),
            REACT_APP_AI_SEARCH_URL: JSON.stringify(
                process.env.REACT_APP_AI_SEARCH_URL || ''
            ),
            REACT_APP_AI_SEARCH_KEY: JSON.stringify(
                process.env.REACT_APP_AI_SEARCH_KEY || ''
            ),
