...
export const useCreateAccount = props => {
    ...
    const [createAccount, { error: createAccountError, loading: createAccountLoading }] = useMutation(
        createAccountMutation,
        {
    ...
    const handleSubmit = useCallback(
        async formValues => {
            ...
            try {
                ...
                const userName = formValues.customer.email.split('@')[0];
                        ...
                        custom_attributes: [
                            {
                                ...
                                value: formValues.customer.telephone
                            }
                        ]
                    },
                ...
                try {
                    ...
                    window.web_event.track("user", "sign_up", {
                        dims: {
                            customers: {
                                "customer_id": CryptoJS.MD5(formValues.customer.telephone).toString(), // MD5(phone)
                                "name": userName,
                                "phone": formValues.customer.telephone,
                                "email": formValues.customer.email,
                                "customer_type": "B2C"
                            }
                        },
