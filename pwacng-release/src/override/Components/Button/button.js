...
import defaultClasses from '@magento/venia-ui/lib/components/Button/button.module.css';
import buttonCustomClasses from '@magenest/theme/BaseComponents/Button/extendStyle/button.module.scss';
...
const Button = props => {
    ...
    const classes = useStyle(defaultClasses, buttonCustomClasses, propClasses);
...
Button.propTypes = {
    ...
    priority: oneOf(['high', 'low', 'normal', 'link']).isRequired,
