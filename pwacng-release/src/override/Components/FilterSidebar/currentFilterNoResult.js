...
import defaultClasses from '@magenest/theme/BaseComponents/FilterSidebar/extendStyle/filterSidebar.module.scss';
...
const FilterSidebar = props => {
    ...
    return (
        <div className={classes.currentFiltersNoResultWrap}>
            <CurrentFilters
                filterApi={filterApi}
