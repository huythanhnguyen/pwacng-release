...
import megaMenuItemCustomClasses from '@magenest/theme/BaseComponents/MegaMenu/extendStyle/megaMenuItem.module.scss';
...
const MegaMenuItem = props => {
    ...
    const classes = useStyle(defaultClasses, megaMenuItemCustomClasses, props.classes);
    ...
    const maybeRightArrowIcon = category.children.length ? (
        <Icon className={classes.arrowRight} src={ArrowRight} size={20} />
    ) : null;
