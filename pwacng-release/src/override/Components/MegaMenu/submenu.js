...
import submenuCustomClasses from '@magenest/theme/BaseComponents/MegaMenu/extendStyle/submenu.module.scss';
...
const Submenu = props => {
    ...
    const classes = useStyle(defaultClasses, submenuCustomClasses, props.classes);
