...
import paymentInformationClasses from '@magenest/theme/BaseComponents/CheckoutPage/extendStyle/paymentInformation.module.scss';
...
const PaymentInformation = props => {
    ...
    const classes = useStyle(defaultClasses, paymentInformationClasses, propClasses);
