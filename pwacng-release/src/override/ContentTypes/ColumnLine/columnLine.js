...
import defaultClasses from '@magento/pagebuilder/lib/ContentTypes/ColumnLine/columnLine.module.css';
...
const ColumnLine = props => {
    ...
    return (
        <div style={dynamicStyles} className={classes.root + ' columnLine'}>
            {children}
        </div>
    );
};
