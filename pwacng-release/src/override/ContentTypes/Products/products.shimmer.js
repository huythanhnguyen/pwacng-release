...
import defaultClasses from '@magenest/theme/BaseComponents/ContentTypes/products.shimmer.module.scss';
...
const ProductsShimmer = props => {
    ...
    return (
        <Shimmer
            ...
            width="100%" height={isMobile ? "330px" : "430px"}
        />
    );
};

/**
 * Props for {@link ProductsShimmer}
 *
 * @typedef props
 *
