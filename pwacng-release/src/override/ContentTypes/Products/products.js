...
const Products = props => {
    ...
    if (loading) return <Shimmer width="100%" height={isMobile ? "330px" : "430px"} />;
    ...
    if (appearance === 'carousel') {
        ...
        if (cssClasses.includes('products-carousel-3')) {
                ...
                responsive: [
                    {
                        breakpoint: 1325,
                        settings: {
                            slidesToShow: slidesToShow3 - 1,
                            slidesToScroll: slidesToShow3 - 1
                        }
                    }
                ],
                ...(carouselCenterMode && {centerPadding}),
                ...{infinite: items.length > slidesToShow3 && infinite}
            };
        ...
        } else if (cssClasses.includes('products-carousel-4')) {
            const slidesToShow4 = 4;
            const carouselSettings = {
                ...
                responsive: [
                    {
                        breakpoint: 1325,
                        settings: {
                            slidesToShow: slidesToShow4 - 1,
                            slidesToScroll: slidesToShow4 - 1
                        }
                    },
                    {
                        breakpoint: 991,
                        settings: {
                            slidesToShow: slidesToShow4 - 2,
                            slidesToScroll: slidesToShow4 - 2
                        }
                    }
                ],
                ...(carouselCenterMode && {centerPadding}),
                ...{infinite: items.length > slidesToShow4 && infinite}
            };
                ...
                responsive: [
                    {
                        breakpoint: 1480,
                        settings: {
                            slidesToShow: slidesToShow5 - 1,
                            slidesToScroll: slidesToShow5 - 1
                        }
                    },
                    {
                        breakpoint: 1325,
                        settings: {
                            slidesToShow: slidesToShow5 - 2,
                            slidesToScroll: slidesToShow5 - 2
                        }
                    },
                    {
                        breakpoint: 991,
                        settings: {
                            slidesToShow: slidesToShow5 - 3,
                            slidesToScroll: slidesToShow5 - 3
                        }
                    }
                ],
                ...(carouselCenterMode && {centerPadding}),
                ...{infinite: items.length > slidesToShow5 && infinite}
            };
    ...
    return (
        <div
            style={dynamicStyles}
            className={[classes.root, ...cssClasses, 'pagebuilderProducts'].join(' ')}
        >
            <Gallery items={items} classes={{ items: classes.galleryItems }} />
        </div>
    );
