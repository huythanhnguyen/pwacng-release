...
import defaultClasses from '@magento/pagebuilder/lib/ContentTypes/Banner/banner.module.css';
...
const Banner = props => {
    ...
    const appearanceOverlayClasses = {
        poster: classes.posterOverlay + ' customPosterOverlay',
    ...
    const appearanceOverlayHoverClasses = {
        poster: classes.posterOverlayHover + ' customPosterOverlayHover',
    ...
    if (typeof link === 'string') {
        ...
        BannerFragment = (
            <LinkComponent
                className={classes.link + ' bannerLink'}
                {...linkProps}
    ...
    return (
        <div
            aria-live="polite"
            aria-busy="false"
            className={[classes.root, ...cssClasses, 'pagebuilderBanner'].join(' ')}
