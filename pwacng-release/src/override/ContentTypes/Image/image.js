...
import defaultClasses from '@magento/pagebuilder/lib/ContentTypes/Image/image.module.css';
import customClasses from '@magenest/theme/BaseComponents/ContentTypes/extendStyle/image.module.scss';
...
const Image = props => {
    ...
    const imgMobileSrc = mobileImage
        ? resourceUrl(mobileImage.src, {
            type: 'image-wysiwyg',
            quality: 85
        })
        : '';
    ...
    const PictureFragment = (cssClasses.includes('two-images') && !!imgSrc && !!imgMobileSrc) ? (
        <>
            <div className={classes.contentTwoImages}>
                <span className={classes.imageCol}>
                    <img
