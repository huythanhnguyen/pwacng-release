...
import defaultClasses from '@magento/pagebuilder/lib/ContentTypes/Row/row.module.css';
import rowCustomClasses from '@magenest/theme/BaseComponents/ContentTypes/extendStyle/row.module.scss';
...
const Row = props => {
    ...
    if (isLazyContent && cssClasses.includes("isLazyContent")) {
        return <></>;
    }

    const backgroundElement = useRef(null);
    const [bgImageStyle, setBgImageStyle] = useState(null);
    const classes = useStyle(defaultClasses, rowCustomClasses, props.classes);
