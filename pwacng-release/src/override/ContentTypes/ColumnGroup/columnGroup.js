...
import defaultClasses from '@magento/pagebuilder/lib/ContentTypes/ColumnGroup/columnGroup.module.css';
...
const ColumnGroup = props => {
    ...
    return (
        <div style={dynamicStyles} className={classes.root + ' columnGroup'}>
            {children}
        </div>
    );
};
